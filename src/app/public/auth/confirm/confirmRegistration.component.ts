...
import {
    UserRegistrationService, UserLoginService, LoggedInCallback,
    IdentityCallback
} from "../../../service/aamsuite.service";
...
export class RegistrationConfirmationComponent implements OnInit, OnDestroy, IdentityCallback {
